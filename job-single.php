        ...
        <div class="row">
          <div class="col-md-8 ftco-animate">
            <h2 class="mb-3"><td><?php echo $title;?></td></h2>
              ...
              <div class="col-md-12" style="background:lightslategrey">
                  <h2 style="color:whitesmoke;text-align: center">Apply</h2>
              </div>

              <form class="col-lg-12"   style="color: black; border:2px solid black;background: lightpink;font-family: 'Segoe Print',serif" enctype="multipart/form-data" action="apply_job.php" method="post">
                  <div style="background: powderblue;border-style: double;border-color: darkblue">
                      <h4 style="color: darkred;font-weight: bolder;font-family: 'Lucida Handwriting';">Other details like Name and qualification will be taken from your profile</h4>
                  </div>
                  <div style="padding: 2%;">
                      <?php
                      $qry=mysqli_query($conn,"Select * from job_seeker where email='{$_SESSION['email']}'");
                  ...
                  <div class="row" >
                      ...
                      <div class="col-sm-6">
                          ...
                          <input type="text" name="experience" id="experience" class="form-control" placeholder="Enter your experience">

                      </div>
                      <div class="col-sm-6">
                          <label for="special_skills">Enter your Special Skills</label><br>
                          <textarea cols="30" name="special_skills" id="special_skills" ></textarea>
                      </div>
                  </div>
                  <div class="row">
                      <div class="col-sm-6">
                          <label for="achievements">Enter your achievements</label>
                          <input type="text" name="achievements" id="achievements" class="form-control" placeholder="Enter your achievements">

                      </div>
                      <div class="col-sm-6">
                          <label for="file">Upload your resume</label>
                          <input type="file" name="file" id="file" class="form-control" placeholder="must be in pdf or doc format">
                      </div>
